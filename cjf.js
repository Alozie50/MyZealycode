...
const ZEALY_URL = 'https://api-v1.zealy.io/communities/jamestest-5158/questboard/v2?filters=locked&filters=available&filters=inCooldown&filters=inReview&filters=completed';
const QUEST_URL = 'https://api-v1.zealy.io/communities/jamestest-5158/quests/v2';
const CLAIM_URL = 'https://api-v1.zealy.io/communities/jamestest-5158/quests/v2';
const INTERVAL = 300;
...
async function submitZealyClaim(questId, taskResults) {
  ...
  const headers = {
    ...
    'x-zealy-subdomain': 'jamestest-5158'
  };
        ...
        while (shouldRetry) {
          ...
          for (const task of taskResults) {
            ...
            if (type === 'tweetReact') {
              ...
              claimTasks.push({ taskId, type, value: "Done" });
            } else if (type === 'file') {
