...
const ZEALY_URL = 'https://api-v1.zealy.io/communities/citizenjournalismfriends/questboard/v2?filters=locked&filters=available&filters=inCooldown&filters=inReview&filters=completed';
const QUEST_URL = 'https://api-v1.zealy.io/communities/citizenjournalismfriends/quests/v2';
const CLAIM_URL = 'https://api-v1.zealy.io/communities/citizenjournalismfriends/quests/v2';
const INTERVAL = 300;
...
async function submitZealyClaim(questId, taskResults) {
  ...
  const headers = {
    ...
    'x-zealy-subdomain': 'citizenjournalismfriends'
  };
