...
const ZEALY_URL = 'https://api-v1.zealy.io/communities/darkexglobal/questboard/v2?filters=locked&filters=available&filters=inCooldown&filters=inReview&filters=completed';
const QUEST_URL = 'https://api-v1.zealy.io/communities/darkexglobal/quests/v2';
const CLAIM_URL = 'https://api-v1.zealy.io/communities/darkexglobal/quests/v2';
const INTERVAL = 300;
const REQUEST_DELAY = 5;
const FILE_PATH = path.join(__dirname, 'asta.json');
const MY_USERNAME = 'alozie50684';
const IS_X_AUTH_CONFIGURED = true;
const ZEALY_COOKIE = 'access_token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiIyNzA1NjI1My0wM2MwLTRkOWQtOTcxMS1hOWM3YzRmMmMwMWQiLCJhY2NvdW50VHlwZSI6ImVtYWlsIiwiZW1haWwiOiJmZWxpeG5tZW5pNTZAZ21haWwuY29tIiwibGFzdEVtYWlsQ2hlY2siOjE3NjYwMDU3Mzg2OTEsImlhdCI6MTc2NjAwNTczOCwiZXhwIjoxNzY4NTk3NzM4fQ.d3cVuQseE-LSuqRHI3z4sDNFAgWnQ3fyaDw4pRG43lM; user_metadata=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiIyNzA1NjI1My0wM2MwLTRkOWQtOTcxMS1hOWM3YzRmMmMwMWQiLCJpYXQiOjE3NjYwMDU3MzgsImV4cCI6MTc2ODU5NzczOH0.tuOeWKXiF08qmbR9EiFKB00Z-gwEY8MNefVoo-zST0c';
...
async function submitZealyClaim(questId, taskResults) {
  ...
  const headers = {
    ...
    'x-zealy-subdomain': 'darkexglobal'
  };
        ...
        while (shouldRetry && retryCount < maxRetries) {
          ...
          for (const task of taskResults) {
            ...
            if (type === 'tweetReact') {
              ...
              claimTasks.push({ taskId, type, value: "" });
            } else if (type === 'file') {
